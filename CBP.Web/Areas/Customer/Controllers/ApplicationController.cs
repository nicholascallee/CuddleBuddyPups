...
namespace CBP.Web.Areas.Customer.Controllers
{
    ...
    public class ApplicationController : Controller
    {
        ...
        [BindProperty]
        public DogApplicationVM DogApplicationVM { get; set; }
        ...
        public IActionResult Index()
        {
            ...
            DogApplicationVM = new()
            {
                DogApplicationList = _unitOfWork.DogApplication.GetAll(u => u.ApplicationUserId == userId,
                includeProperties: "Dog")
            };

            IEnumerable<DogImage> dogImages = _unitOfWork.DogImage.GetAll();

            return View(DogApplicationVM);
        }
